...
public class ExercisesTest {
	...
	public void firstLast6() {
		...
		assertEquals("Input: firstLast6(new int[]{13, 6, 1, 2, 3})", false, exercises.firstLast6(new int[]{13, 6, 1, 2, 3}));
	}
	...
	public void commonEnd() {
		assertEquals("Input: commonEnd(new int[]{1, 2, 3}, new int[]{7, 3})", true, exercises.commonEnd(new int[]{1, 2, 3}, new int[]{7, 3}));
		assertEquals("Input: commonEnd(new int[]{1, 2, 3}, new int[]{7, 3, 2})", false, exercises.commonEnd(new int[]{1, 2, 3}, new int[]{7, 3, 2}));
		assertEquals("Input: commonEnd(new int[]{1, 2, 3}, new int[]{1, 3})", true, exercises.commonEnd(new int[]{1, 2, 3}, new int[]{1, 3}));
	}
	...
	public void rotateLeft3() {
		assertArrayEquals("Input: rotateLeft3(new int[]{1, 2, 3})", new int[]{2, 3, 1}, exercises.rotateLeft3(new int[]{1, 2, 3}));
		assertArrayEquals("Input: rotateLeft3(new int[]{5, 11, 9})", new int[]{11, 9, 5}, exercises.rotateLeft3(new int[]{5, 11, 9}));
		assertArrayEquals("Input: rotateLeft3(new int[]{7, 0, 0})", new int[]{0, 0, 7}, exercises.rotateLeft3(new int[]{7, 0, 0}));
	}
	...
	public void reverse3() {
		assertArrayEquals("Input: reverse3(new int[]{1, 2, 3})", new int[]{3, 2, 1}, exercises.reverse3(new int[]{1, 2, 3}));
		assertArrayEquals("Input: reverse3(new int[]{5, 11, 9})", new int[]{9, 11, 5}, exercises.reverse3(new int[]{5, 11, 9}));
		assertArrayEquals("Input: reverse3(new int[]{7, 0, 0})", new int[]{0, 0, 7}, exercises.reverse3(new int[]{7, 0, 0}));
	}
	...
	@Test
	public void maxEnd3() {
		assertArrayEquals("Input: maxEnd3(new int[]{1, 2, 3})", new int[]{3, 3, 3}, exercises.maxEnd3(new int[]{1, 2, 3}));
		assertArrayEquals("Input: maxEnd3(new int[]{11, 5, 9})", new int[]{11, 11, 11}, exercises.maxEnd3(new int[]{11, 5, 9}));
		assertArrayEquals("Input: maxEnd3(new int[]{2, 11, 3})", new int[]{3, 3, 3}, exercises.maxEnd3(new int[]{2, 11, 3}));
	}
	...
	public void middleWay() {
		assertArrayEquals("Input: middleWay(new int[]{1, 2, 3}, new int[]{4, 5, 6})", new int[]{2, 5}, exercises.middleWay(new int[]{1, 2, 3}, new int[]{4, 5, 6}));
		assertArrayEquals("Input: middleWay(new int[]{7, 7, 7}, new int[]{3, 8, 0})", new int[]{7, 8}, exercises.middleWay(new int[]{7, 7, 7}, new int[]{3, 8, 0}));
		assertArrayEquals("Input: middleWay(new int[]{5, 2, 9}, new int[]{1, 4, 5})", new int[]{2, 4}, exercises.middleWay(new int[]{5, 2, 9}, new int[]{1, 4, 5}));
	}
	...
	public void countEvens() {
		assertEquals("Input: countEvens(new int[]{2, 1, 2, 3, 4})", 3, exercises.countEvens(new int[]{2, 1, 2, 3, 4}));
